...
const ChildCard: React.FC<childPropsArray> = ({ childProperties }) => {
    return (
...
//     <main className='w-full flex justify-center items-center gap-3  p-2'>
//         <div className='flex justify-center items-center gap-3 w-[80%] border-red-500 border-[2px] flex-wrap'>
//         {
...
//                         <Image src={child.picture} alt='' width={190} height={180}></Image>
//                         <h3>{child.heading}</h3>
//                         <h3><span>{child.price1}</span><span>{child.price2}</span></h3>
//                         <div><span>{child.reviews}</span><span>{child.comment}</span></div>
//                     </div>
//                 )
//             })
//         }
